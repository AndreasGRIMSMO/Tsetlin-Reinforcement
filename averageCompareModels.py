    ...
    for j in range(episodes):  # episodes
        ...
        while True:
            ...
            if done:
                ...
                score = 0
                break
    ppo_demo_scores.append(temp_result)

data = np.asarray(ppo_demo_scores)
np.savetxt('ppo_demo_scores_100.csv', data, delimiter=',')
...
ax = sns.lineplot(x=np.arange(0, len(mean_ppo_demo_scores), 1), y=np.asarray(mean_ppo_demo_scores))
ax.set(xlabel='Episode', ylabel='Score')
plt.title('PPO Demo Tsetlin Scores')
plt.show()
    ...
    for j in range(episodes):  # episodes
        ...
        while True:
            ...
            if done:
                ...
                score = 0
                break
    ppo_scores.append(temp_result)

data = np.asarray(ppo_scores)
np.savetxt('ppo_scores_100.csv', data, delimiter=',')
...
ax = sns.lineplot(x=np.arange(0, len(mean_ppo_scores), 1), y=np.asarray(mean_ppo_scores))
ax.set(xlabel='Episode', ylabel='Score')
plt.title('PPO Tsetlin Scores')
plt.show()
    ...
    for j in range(episodes):  # episodes
        ...
        while True:
            ...
            if done:
                ...
                score = 0
                break
    math_scores.append(temp_result)

data = np.asarray(math_scores)
np.savetxt('math_scores_100.csv', data, delimiter=',')
...
ax = sns.lineplot(x=np.arange(0, len(mean_math_scores), 1), y=np.asarray(mean_math_scores))
ax.set(xlabel='Episode', ylabel='Score')
plt.title('Math Tsetlin Scores')
plt.show()
